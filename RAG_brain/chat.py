...
def ask_avatar(user_question):
    ...
    print("Searching vector memory and thinking locally...")

    # 2. Embed user question locally
    ...
    messages = [
        {
            "role": "system",
            "content": f"""You are an AI assistant from Sham Marianas representing developer Arham Mahmood.
...
2. Always refer to Arham Mahmood in the third person ("Arham Mahmood is...", "His skills are...")[cite: 1, 2]. Never pretend to be Arham.
...
"""
    ...
    # 7. Generate response locally via Ollama
